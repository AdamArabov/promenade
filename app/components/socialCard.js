  ...
  return (
    <div className="flex flex-col items-end justify-center h-screen relative">
      <div className="z-10 absolute bottom-0 right-4 md:bottom-auto md:right-auto md:flex md:flex-col">
        <a href="https://www.instagram.com/promenadewines" target="_blank" rel="noopener noreferrer" className="mb-2 md:mb-1 flex">
        ...
        <a href="https://www.tiktok.com/@promenadewine" target="_blank" rel="noopener noreferrer" className="flex">
